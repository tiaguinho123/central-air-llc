            ...
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <div className="space-y-7 mb-10">
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#D120271A' }}>
                    <Phone className="w-5 h-5" style={{ color: '#D12027' }} aria-hidden="true" />
                  </div>
                  <div>
                    <p className="font-bold text-slate-900 mb-1">Phone</p>
                    <a href={`tel:${phone}`} className="text-2xl font-extrabold transition-colors" style={{ color: '#D12027' }}>{phoneFormatted}</a>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#D120271A' }}>
                    <Mail className="w-5 h-5" style={{ color: '#D12027' }} aria-hidden="true" />
                  </div>
                  <div>
                    <p className="font-bold text-slate-900 mb-1">Email</p>
                    <a href={`mailto:${email}`} className="text-slate-700 hover:text-[#D12027] transition-colors">{email}</a>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#D120271A' }}>
                    <MapPin className="w-5 h-5" style={{ color: '#D12027' }} aria-hidden="true" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#D120271A' }}>
                    <Clock className="w-5 h-5" style={{ color: '#D12027' }} aria-hidden="true" />
                  </div>
                  <div>
                    ...
                    {hours.emergency && <p className="font-bold mt-1" style={{ color: '#D12027' }}>Emergency: 24 Hours / 7 Days</p>}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
                {submitted ? (
                  <div className="text-center py-12">
                    <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: '#D12027' }}>
                      <Send className="w-8 h-8 text-white" aria-hidden="true" />
                    </div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-3">Message Sent!</h3>
                    <p className="text-slate-600">We'll be in touch shortly. For urgent needs, call <a href={`tel:${phone}`} className="font-bold" style={{ color: '#D12027' }}>{phoneFormatted}</a>.</p>
                  </div>
                ) : (
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5" aria-label="Contact form">
                      <div className="grid sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input id="contact-first" type="text" required autoComplete="given-name" placeholder="John"
                            className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-[#D12027] bg-white transition" />
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        <textarea id="contact-message" rows={4} placeholder="Describe your HVAC issue or ask a question..."
                          className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-[#D12027] bg-white transition resize-none" />
                      </div>
                      <button type="submit"
